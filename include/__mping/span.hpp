...
///
/// Since xxxxx-1 needs to be C++17 compatible and \c std::span is part of C++20, we need our own implementation of
...
public:
    ...
    /// <code>data() == xxxxx-1ing::internal::to_address(first)</code> and <code>size() == last-first</code>.
    ///
