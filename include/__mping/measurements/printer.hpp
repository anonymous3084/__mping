...
/// @brief Printer class that prints an evaluated xxxxx-1erTree in Json format.
///
...
public:
    ...
    /// @brief Prints an evaluated xxxxx-1erTree in Json format to stdout.
    /// @todo expose indentation parameter to make the indentation customizable.
    /// @param node Root node of the xxxxx-1erTree to print.
...
/// @brief Printer class that prints an evaluated xxxxx-1erTree in a flat format in which the timer hierarchy is collapsed
