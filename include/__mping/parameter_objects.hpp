...
public:
    ...
    static constexpr bool is_lib_allocated =
        DataBufferType::is_lib_allocated; ///< Indicates whether the buffer is allocated by xxxxx-1.
...
/// @brief Parameter object representing a data buffer to be allocated by xxxxx-1. This is a specialization of \ref
