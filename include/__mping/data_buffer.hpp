...
/// \c MPI calls wrapped by xxxxx-1.
///
...
#include "xxxxx-1ing/kabool.hpp"
#include "xxxxx-1ing/named_parameter_types.hpp"
#include "xxxxx-1ing/span.hpp"
#include "kassert/kassert.hpp"

namespace xxxxx-1ing {
/// @addtogroup xxxxx-1ing_mpi_utility
/// @{
...
xxxxx-1_MAKE_HAS_MEMBER(resize)

} // namespace internal

/// @brief Buffer allocation tag used for indicating that a buffer should be allocated by xxxxx-1.
...
/// @brief Buffer allocation tag used for indicating that a buffer of type \p T should be allocated by xxxxx-1.
...
/// @tparam modifiability `modifiable` if a xxxxx-1 operation is allowed to
...
public:
    ...
    /// @brief Indicates whether the buffer is allocated by xxxxx-1.
    ...
    //     "Buffers based on std::vector<bool> are not supported, use std::vector<xxxxx-1ing::kabool> instead.");
...
// ///
// /// An initializer list of type \c bool will be converted to a \c std::vector<xxxxx-1ing::kabool>.
// ///
// /// @tparam parameter_type parameter type represented by this buffer.
// /// @tparam modifiability `modifiable` if a xxxxx-1 operation is allowed to
// /// modify the underlying container. `constant` otherwise.
