...
/// @file
/// The class defined in this file serve as wrapper for functions passed to \c MPI calls wrapped by xxxxx-1.
...
/// such wrapper using the parameter factory \c xxxxx-1ing::op without passing the type of the operation. The library
...
public:
    ...
    /// @param commutative_tag tag indicating if the operation is commutative (see \c xxxxx-1ing::op for details)
