...
#include "xxxxx-1ing/named_parameters_detail/status_parameters.hpp"
...
//// @addtogroup xxxxx-1ing_named_parameters
/// @{
...
/// @param ignore Tag parameter for overload dispatching, pass in `xxxxx-1ing::ignore<Data>`.
...
/// @brief Passes a \p container, into which the send counts deduced by xxxxx-1 will be written, to the underlying call.
...
/// resize policy is BufferResizePolicy::no_resize, indicating that the buffer should not be resized by xxxxx-1.
...
/// @brief Indicates to construct an object of type \p Container, into which the send counts deduced by xxxxx-1 will be
...
/// @brief Indicates to construct a container with type \p Container<int>, into which the send counts deduced by xxxxx-1
...
/// @brief Indicates to construct a container with type \ref xxxxx-1ing::Communicator::default_container_type<int>, into
/// which the send counts deduced by xxxxx-1 will be written, in the underlying call.
///
/// The send counts container will be returned as part of the underlying call's result object.
///
/// @tparam Container Container type which will contains the send counts.
...
/// @brief Passes \p count, into which the send count deduced by xxxxx-1 will be written, to the underlying call.
...
/// @brief Passes a \p container, into which the recv counts deduced by xxxxx-1 will be written, to the underlying call.
/// \p Container must satisfy the following constraints:
/// - provide a \c data() member function
/// - provide a \c size() member function
/// - expose \c value_type (which must be int).
...
/// @brief Indicates to construct an object of type \p Container, into which the recv counts deduced by xxxxx-1 will be
/// written, in the underlying call.
/// \p Container must satisfy the following constraints:
/// - provide a \c data() member function
/// - provide a \c size() member function
...
/// @brief Indicates to construct a container with type \p Container<int>, into which the recv counts deduced by xxxxx-1
/// will be written, in the underlying call.
///
/// \p Container<int> must satisfy the following constraints:
/// - provide a \c data() member function
...
/// @brief Indicates to construct a container with type \ref xxxxx-1ing::Communicator::default_container_type<int>, into
/// which the recv counts deduced by xxxxx-1 will be written, in the underlying call.
///
/// The recv counts container will be returned as part of the underlying call's result object.
///
/// @tparam Container Container type which will contains the recv counts.
...
/// @brief Passes \p count, into which the recv count deduced by xxxxx-1 will be written, to the underlying call.
...
/// @brief Passes \p count, into which the send/recv count deduced by xxxxx-1 will be written, to the underlying call.
...
/// @brief Passes a \p container, into which the send displacements deduced by xxxxx-1 will be written, to the
...
/// @brief Indicates to construct an object of type \p Container, into which the send displacements deduced by xxxxx-1
...
/// xxxxx-1 will be written, in the underlying call.
///
/// \p Container<int> must satisfy the following constraints:
/// - provide a \c data() member function
/// - provide a \c size() member function
...
/// @brief Indicates to construct a container with type \ref xxxxx-1ing::Communicator::default_container_type<int>, into
/// which the send displacements deduced by xxxxx-1 will be written, in the underlying call.
///
/// The send displacements container will be returned as part of the underlying call's result object.
///
/// @tparam Container Container type which will contains the send displacements.
...
/// @brief Passes a \p container, into which the receive displacements deduced by xxxxx-1 will be written, to the
/// underlying call. \p Container must satisfy the following constraints:
/// - provide a \c data() member function
/// - provide a \c size() member function
/// - expose \c value_type (which must be int).
...
/// xxxxx-1 will be written, in the underlying call. \p Container must satisfy the following constraints:
/// - provide a \c data() member function
/// - provide a \c size() member function
/// - provide a \c resize(unsigned int) member function
/// - expose \c value_type (which must be int).
...
/// by xxxxx-1 will be written, in the underlying call.
///
/// \p Container<int> must satisfy the following constraints:
/// - provide a \c data() member function
/// - provide a \c size() member function
...
/// @brief Indicates to construct a container with type \ref xxxxx-1ing::Communicator::default_container_type<int>, into
/// which the receive displacements deduced by xxxxx-1 will be written, in the underlying call.
///
/// The receive displacements container will be returned as part of the underlying call's result object.
///
/// @tparam Container Container type which will contains the receive displacements.
...
///   recv_buf_out(xxxxx-1ing::as_deserializable<dict_type>());
/// ```
/// @see \ref docs/parameter_handling.md for general information about parameter handling in xxxxx-1.
template <
    typename SerializationBufferType,
...
/// ```cpp
///   using dict_type = std::unordered_map<int, double>;
///   recv_buf(xxxxx-1ing::as_deserializable<dict_type>());
/// ```
///
/// @see Alias for \ref recv_buf_out(Container&&).
/// @see \ref docs/parameter_handling.md for general information about parameter handling in xxxxx-1.
...
/// @brief Indicates to construct a container with type \ref xxxxx-1ing::Communicator::default_container_type<\p
...
/// Pass any of the tags from the \c xxxxx-1ing::send_modes namespace.
///
/// @return The corresponding parameter object.
/// @see \ref docs/parameter_handling.md for general information about parameter handling in xxxxx-1.
...
/// xxxxx-1ing::Communicator::exscan().
///
...
/// \ref xxxxx-1ing::Communicator::exscan().
///
...
/// @brief Passes \p send_type, into which the send type deduced by xxxxx-1 will be written, to the underlying call.
...
/// @brief Passes \p recv_type, into which the recv type deduced by xxxxx-1 will be written, to the underlying call.
/// The type will be stored at the location referred to by the provided reference.
///
...
/// @brief Passes \p send_recv_type, into which the send/recv type deduced by xxxxx-1 will be written, to the underlying
