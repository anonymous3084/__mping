...
/// @tparam StatusObject type of the status object, may either be \c MPI_Status or \ref xxxxx-1ing::Status
...
/// @brief Constructs a status object internally, which may then be retrieved from \c xxxxx-1ing::MPIResult returned by the
/// operation.
