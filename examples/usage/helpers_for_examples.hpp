...
/// @param comm xxxxx-1 communicator to get the rank of the PE.
template <
    template <typename...>
...
/// @param comm xxxxx-1 communicator to determine which PE is the root PE.
...
/// @tparam Communicator Type of communicator (has to be a xxxxx-1 communicator).
