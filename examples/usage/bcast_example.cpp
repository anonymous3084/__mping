...
int main() {
    ...
    // - xxxxx-1 cannot deduce the receive type and we have to explicitly provide the C++ type using a template
    //   parameter.
    ...
    if (comm.is_root()) {
        ...
        // Let xxxxx-1 allocate the receive buffer.
    ...
    // xxxxx-1 automatically performs the second broadcast necessary to provideall ranks with the correct receive
