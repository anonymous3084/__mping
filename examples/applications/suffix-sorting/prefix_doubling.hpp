...
/// @param comm The xxxxx-1 communicator used for this algorithms.
...
auto reduce_alphabet(
    std::vector<std::uint8_t>&& input, xxxxx-1ing::Communicator<std::vector, xxxxx-1ing::plugin::SampleSort>& comm
) {
...
/// @param comm xxxxx-1 communicator used for this algorithm.
/// @return The suffix array for the concatenation of all \c inputs.
template <typename IndexType>
std::vector<IndexType>
prefix_doubling(std::vector<uint8_t>&& input, xxxxx-1ing::Communicator<std::vector, xxxxx-1ing::plugin::SampleSort>& comm) {
    using namespace xxxxx-1ing;
