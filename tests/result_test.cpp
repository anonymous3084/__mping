...
void test_recv_buffer_in_MPIResult() {
    ...
    auto construct_recv_buffer = []() {
        auto recv_buffer = recv_buf(xxxxx-1ing::alloc_new<UnderlyingContainer>).construct_buffer_or_rebind();
        static_assert(
...
TEST(MpiResultTest, extract_send_recv_count) {
    ...
    auto construct_send_recv_count = []() {
        auto send_recv_count         = xxxxx-1ing::send_recv_count_out().construct_buffer_or_rebind();
...
TEST(MpiResultTest, extract_send_type) {
    ...
    auto construct_send_type = []() {
        auto send_type         = xxxxx-1ing::send_type_out().construct_buffer_or_rebind();
...
TEST(MpiResultTest, extract_recv_type) {
    ...
    auto construct_recv_type = []() {
        auto recv_type         = xxxxx-1ing::recv_type_out().construct_buffer_or_rebind();
...
TEST(MpiResultTest, extract_send_recv_type) {
    ...
    auto construct_send_recv_type = []() {
        auto send_recv_type         = xxxxx-1ing::send_recv_type_out().construct_buffer_or_rebind();
...
xxxxx-1_MAKE_HAS_MEMBER(extract_recv_buffer)
xxxxx-1_MAKE_HAS_MEMBER(extract_recv_counts)
xxxxx-1_MAKE_HAS_MEMBER(extract_recv_count)
xxxxx-1_MAKE_HAS_MEMBER(extract_recv_displs)
xxxxx-1_MAKE_HAS_MEMBER(extract_send_counts)
xxxxx-1_MAKE_HAS_MEMBER(extract_send_count)
xxxxx-1_MAKE_HAS_MEMBER(extract_send_displs)
xxxxx-1_MAKE_HAS_MEMBER(extract_send_recv_count)
xxxxx-1_MAKE_HAS_MEMBER(extract_send_type)
xxxxx-1_MAKE_HAS_MEMBER(extract_recv_type)
xxxxx-1_MAKE_HAS_MEMBER(extract_send_recv_type)
...
TEST(MpiResultTest, removed_extract_functions) {
    ...
    constexpr BufferType btype = BufferType::out_buffer;
    {
        ...
        xxxxx-1ing::MPIResult mpi_result_sanity_check{std::make_tuple(
...

    {
        ...
        xxxxx-1ing::MPIResult mpi_result{std::make_tuple()};
