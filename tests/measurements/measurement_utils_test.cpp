...
TEST(xxxxx-1erTreeNodeTest, aggregate_measurements_locally_basic_appending) {
    xxxxx-1erTreeNode<int, int> node;
...
TEST(xxxxx-1erTreeNodeTest, aggregate_measurements_locally_basic_accumulate) {
    xxxxx-1erTreeNode<int, int> node;
    int const               duration1 = 2;
    int const               duration2 = 1;
    int const               duration3 = 3;
...
TEST(xxxxx-1erTreeNodeTest, aggregate_measurements_locally_basic_interleaved) {
    xxxxx-1erTreeNode<int, int> node;
    int const               duration1 = 2;
    int const               duration2 = 1;
    int const               duration3 = 3;
...
TEST(xxxxx-1erTreeTest, constructor) {
    xxxxx-1erTree<int, std::size_t> timer_tree;
