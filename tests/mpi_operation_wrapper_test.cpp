...
TEST(UserOperationWrapperTest, test_local_reduction_stl_operation) {
    {
        xxxxx-1ing::internal::UserOperationWrapper<true, int, std::plus<>> op(std::plus<>{});
    ...
    {
        xxxxx-1ing::internal::UserOperationWrapper<false, int, std::plus<>> op(std::plus<>{});
        std::array<int, 2>                                               a = {42, 69};
        std::array<int, 2>                                               b = {24, 96};
        MPI_Reduce_local(a.data(), b.data(), 2, MPI_INT, op.get_mpi_op());
        std::array<int, 2> expected_result = {42 + 24, 69 + 96};
...
TEST(UserOperationWrapperTest, test_local_reduction_function_object) {
    ...
    {
        xxxxx-1ing::internal::UserOperationWrapper<true, int, MyOperation> op(MyOperation{});
        std::array<int, 2>                                              a = {42, 69};
        std::array<int, 2>                                              b = {24, 96};
        MPI_Reduce_local(a.data(), b.data(), 2, MPI_INT, op.get_mpi_op());
        std::array<int, 2> expected_result = {42 + 24, 69 + 96};
    ...
    {
        xxxxx-1ing::internal::UserOperationWrapper<false, int, MyOperation> op(MyOperation{});
        std::array<int, 2>                                               a = {42, 69};
        std::array<int, 2>                                               b = {24, 96};
        MPI_Reduce_local(a.data(), b.data(), 2, MPI_INT, op.get_mpi_op());
        std::array<int, 2> expected_result = {42 + 24, 69 + 96};
...
TEST(UserOperationPtrWrapper, test_local_reduction_with_wrapped_function_ptr) {
    xxxxx-1ing::internal::mpi_custom_operation_type op_ptr =
    ...
    {
        xxxxx-1ing::internal::UserOperationPtrWrapper<true> op(op_ptr);
        std::array<int, 2>                               a = {42, 69};
        std::array<int, 2>                               b = {24, 96};
        MPI_Reduce_local(a.data(), b.data(), 2, MPI_INT, op.get_mpi_op());
        std::array<int, 2> expected_result = {42 + 24, 69 + 96};
    ...
    {
        xxxxx-1ing::internal::UserOperationPtrWrapper<false> op(op_ptr);
        std::array<int, 2>                                a = {42, 69};
        std::array<int, 2>                                b = {24, 96};
        MPI_Reduce_local(a.data(), b.data(), 2, MPI_INT, op.get_mpi_op());
        std::array<int, 2> expected_result = {42 + 24, 69 + 96};
...
auto make_op(Op&& op, Commutative commutative) {
    return xxxxx-1ing::internal::ReduceOperation<T, Op, Commutative>(std::move(op), commutative);
}
...
TEST(ReduceOperationTest, test_dispatch_for_builtin_function_object_and_lambda) {
    ...
    // builtin operation
    {
        auto op = make_op<int>(std::plus<>{}, xxxxx-1ing::ops::internal::undefined_commutative_tag{});
    ...
    {
        auto op = make_op<WrappedInt>(std::plus<>{}, xxxxx-1ing::ops::commutative);
    ...
    {
        auto op = make_op<WrappedInt>(std::plus<>{}, xxxxx-1ing::ops::non_commutative);
        EXPECT_NE(op.op(), MPI_SUM);
        EXPECT_EQ(op(WrappedInt{3}, WrappedInt{4}), WrappedInt{7});
        EXPECT_FALSE(decltype(op)::is_builtin);
    ...
    {
        auto op = make_op<int>(MPI_SUM, xxxxx-1ing::ops::internal::undefined_commutative_tag{});
        EXPECT_EQ(op.op(), MPI_SUM);
        EXPECT_EQ(op(3, 4), 7);
        EXPECT_FALSE(decltype(op)::is_builtin);
    }
    // custom native operation
    {
        ...
        auto op =
            xxxxx-1ing::internal::ReduceOperation<int, MPI_Op, xxxxx-1ing::ops::internal::undefined_commutative_tag>(native_op
            );
    ...
    {
        auto op = make_op<int>([](auto a, auto b) { return a + b; }, xxxxx-1ing::ops::commutative);
        EXPECT_NE(op.op(), MPI_SUM);
        EXPECT_EQ(op(3, 4), 7);
        EXPECT_FALSE(decltype(op)::is_builtin);
    ...
    {
        auto op = make_op<int>([](auto a, auto b) { return a + b; }, xxxxx-1ing::ops::non_commutative);
        EXPECT_NE(op.op(), MPI_SUM);
        EXPECT_EQ(op(3, 4), 7);
        EXPECT_FALSE(decltype(op)::is_builtin);
    ...
    {
        auto op = make_op<WrappedInt>([](auto a, auto b) { return a + b; }, xxxxx-1ing::ops::commutative);
        EXPECT_NE(op.op(), MPI_SUM);
        EXPECT_EQ(op(WrappedInt{3}, WrappedInt{4}), WrappedInt{7});
        EXPECT_FALSE(decltype(op)::is_builtin);
    ...
    {
        auto op = make_op<WrappedInt>([](auto a, auto b) { return a + b; }, xxxxx-1ing::ops::non_commutative);
        EXPECT_NE(op.op(), MPI_SUM);
        EXPECT_EQ(op(WrappedInt{3}, WrappedInt{4}), WrappedInt{7});
        EXPECT_FALSE(decltype(op)::is_builtin);
