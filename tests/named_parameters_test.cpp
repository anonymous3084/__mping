...
void test_const_buffer(
    ...
    xxxxx-1ing::internal::ParameterType expected_parameter_type,
    xxxxx-1ing::internal::BufferType    expected_buffer_type,
...
void test_user_allocated_buffer(
    ...
    xxxxx-1ing::internal::ParameterType expected_parameter_type,
    xxxxx-1ing::internal::BufferType    expected_buffer_type,
    xxxxx-1ing::BufferResizePolicy      expected_resize_policy,
...
TEST(ParameterFactoriesTest, status_basics) {
    {
        auto status_obj = status(xxxxx-1ing::ignore<>).construct_buffer_or_rebind();
