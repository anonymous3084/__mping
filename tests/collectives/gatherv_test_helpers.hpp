...
struct ExpectedBuffersForRankxxxxx-1esRankGathering {
    ...
    static auto recv_buffer_on_receiving_ranks(xxxxx-1ing::Communicator<> const& comm) {
    ...
    static auto recv_counts_on_receiving_ranks(xxxxx-1ing::Communicator<> const& comm) {
    ...
    template <template <typename...> typename Container = std::vector>
    static auto recv_displs_on_receiving_ranks(xxxxx-1ing::Communicator<> const& comm) {
