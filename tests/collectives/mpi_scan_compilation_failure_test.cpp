...
int main(int /*argc*/, char** /*argv*/) {
    ...
    comm.scan(send_buf(input), send_recv_type(MPI_INT), op(xxxxx-1ing::ops::plus<>{}), recv_buf<no_resize>(recv_buffer));
    ...
    int const        result = comm.scan_single(send_buf(input), op(xxxxx-1ing::ops::plus<>{}));
#else
