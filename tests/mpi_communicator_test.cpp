...
#include "xxxxx-1ing/comm_helper/num_numa_nodes.hpp"
...
// Using xxxxx-1_ASSERTION_LEVEL_HEAVY because EXPECT_KASSERT_FAILS only checks for failing kasserts on that level
#if KASSERT_ENABLED(xxxxx-1_ASSERTION_LEVEL_HEAVY)
