...
TEST(HasDataMemberTest, has_data_member_basics) {
    EXPECT_TRUE(xxxxx-1ing::internal::has_data_member_v<std::vector<int>>);
    EXPECT_TRUE(xxxxx-1ing::internal::has_data_member_v<std::vector<double>>);
    EXPECT_TRUE((xxxxx-1ing::internal::has_data_member_v<std::vector<double, ::testing::CustomAllocator<double>>>));
    EXPECT_TRUE((xxxxx-1ing::internal::has_data_member_v<std::string>));
    EXPECT_TRUE((xxxxx-1ing::internal::has_data_member_v<std::array<int, 42>>));

    EXPECT_FALSE((xxxxx-1ing::internal::has_data_member_v<int>));
    EXPECT_FALSE((xxxxx-1ing::internal::has_data_member_v<bool>));

    // on some compilers vector<bool> still has .data() but it returns void
    // EXPECT_FALSE((xxxxx-1ing::internal::has_data_member_v<std::vector<bool>>));
    // EXPECT_FALSE((xxxxx-1ing::internal::has_data_member_v<std::vector<bool, testing::CustomAllocator<bool>>>));
}

TEST(IsSpecializationTest, is_specialization_basics) {
    EXPECT_TRUE((xxxxx-1ing::internal::is_specialization<std::vector<int>, std::vector>::value));
    EXPECT_TRUE((xxxxx-1ing::internal::is_specialization<std::vector<bool>, std::vector>::value));
    EXPECT_TRUE(
        (xxxxx-1ing::internal::is_specialization<std::vector<int, ::testing::CustomAllocator<int>>, std::vector>::value)
    );
    EXPECT_TRUE((xxxxx-1ing::internal::
                     is_specialization<std::vector<double, ::testing::CustomAllocator<double>>, std::vector>::value));
    EXPECT_TRUE((xxxxx-1ing::internal::is_specialization<std::deque<int>, std::deque>::value));

    EXPECT_FALSE((xxxxx-1ing::internal::is_specialization<std::array<int, 2>, std::vector>::value));
    EXPECT_FALSE((xxxxx-1ing::internal::is_specialization<std::deque<int>, std::vector>::value));
    EXPECT_FALSE((xxxxx-1ing::internal::is_specialization<int, std::vector>::value));
}
TEST(HasValueTypeTest, has_value_type_basics) {
    EXPECT_TRUE(xxxxx-1ing::internal::has_value_type_v<std::vector<int>>);
    EXPECT_TRUE(xxxxx-1ing::internal::has_value_type_v<std::vector<bool>>);
    EXPECT_TRUE((xxxxx-1ing::internal::has_value_type_v<std::array<int, 42>>));
    EXPECT_TRUE((xxxxx-1ing::internal::has_value_type_v<std::string>));

    EXPECT_FALSE((xxxxx-1ing::internal::has_value_type_v<int>));
    EXPECT_FALSE((xxxxx-1ing::internal::has_value_type_v<double>));
    EXPECT_FALSE((xxxxx-1ing::internal::has_value_type_v<bool>));
}

TEST(IsVectorBoolTest, is_vector_bool_basics) {
    EXPECT_TRUE(xxxxx-1ing::internal::is_vector_bool_v<std::vector<bool>>);
    EXPECT_TRUE((xxxxx-1ing::internal::is_vector_bool_v<std::vector<bool, ::testing::CustomAllocator<bool>>>));
    EXPECT_TRUE(xxxxx-1ing::internal::is_vector_bool_v<std::vector<bool> const>);
    EXPECT_TRUE(xxxxx-1ing::internal::is_vector_bool_v<std::vector<bool>&>);
    EXPECT_TRUE(xxxxx-1ing::internal::is_vector_bool_v<std::vector<bool> const&>);
    EXPECT_FALSE(xxxxx-1ing::internal::is_vector_bool_v<std::vector<int>>);
    EXPECT_FALSE((xxxxx-1ing::internal::is_vector_bool_v<std::vector<int, ::testing::CustomAllocator<int>>>));
    EXPECT_FALSE(xxxxx-1ing::internal::is_vector_bool_v<std::vector<int>&>);
    EXPECT_FALSE(xxxxx-1ing::internal::is_vector_bool_v<std::vector<int> const&>);
    EXPECT_FALSE(xxxxx-1ing::internal::is_vector_bool_v<std::vector<xxxxx-1ing::kabool>>);
    EXPECT_FALSE(xxxxx-1ing::internal::is_vector_bool_v<std::vector<xxxxx-1ing::kabool>&>);
    EXPECT_FALSE(xxxxx-1ing::internal::is_vector_bool_v<std::vector<xxxxx-1ing::kabool> const&>);
    EXPECT_FALSE(xxxxx-1ing::internal::is_vector_bool_v<bool>);
    EXPECT_FALSE(xxxxx-1ing::internal::is_vector_bool_v<bool&>);
    EXPECT_FALSE(xxxxx-1ing::internal::is_vector_bool_v<bool const&>);
    EXPECT_FALSE(xxxxx-1ing::internal::is_vector_bool_v<int>);
    EXPECT_FALSE(xxxxx-1ing::internal::is_vector_bool_v<int&>);
    EXPECT_FALSE(xxxxx-1ing::internal::is_vector_bool_v<int const&>);
}
...
TEST(EmptyBufferTest, get_basics) {
    ...
    EmptyDataBuffer<std::vector<int>, ptype, xxxxx-1ing::internal::BufferType::ignore> empty_buffer{};
