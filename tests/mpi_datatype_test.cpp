...
TEST(MpiDataTypeTest, mpi_datatype_basics) {
    ...
    EXPECT_THAT(possible_mpi_datatypes<xxxxx-1ing::kabool>(), Contains(mpi_type_traits<xxxxx-1ing::kabool>::data_type()));
    EXPECT_THAT(
...
TEST(MpiDataTypeTest, contiguous_type_works) {
    ...
    MPI_Datatype         contiguous_type = xxxxx-1ing::contiguous_type<float, 3>::data_type();
    int                  num_integers, num_addresses, num_datatypes, combiner;
...
TEST(MpiDataTypeTest, byte_serialized_type_works) {
    ...
    MPI_Datatype           byte_serialized_type = xxxxx-1ing::byte_serialized<std::pair<int, double>>::data_type();
    int                    num_integers, num_addresses, num_datatypes, combiner;
...
TEST(MpiDataTypeTest, struct_type_works_with_struct) {
    ...
    MPI_Datatype resized_type = xxxxx-1ing::struct_type<TestStruct>::data_type();
    int          num_integers, num_addresses, num_datatypes, combiner;
...
TEST(MpiDataTypeTest, struct_type_works_with_pair) {
    MPI_Datatype resized_type = xxxxx-1ing::struct_type<std::pair<uint8_t, uint64_t>>::data_type();
    int          num_integers, num_addresses, num_datatypes, combiner;
    MPI_Type_get_envelope(resized_type, &num_integers, &num_addresses, &num_datatypes, &combiner);
    EXPECT_EQ(combiner, MPI_COMBINER_RESIZED);
    // returned values for MPI_COMBINER_RESIZED
...
TEST(MpiDataTypeTest, struct_type_works_with_tuple) {
    ...
    MPI_Datatype resized_type = xxxxx-1ing::struct_type<Tuple>::data_type();
    int          num_integers, num_addresses, num_datatypes, combiner;
    MPI_Type_get_envelope(resized_type, &num_integers, &num_addresses, &num_datatypes, &combiner);
    EXPECT_EQ(combiner, MPI_COMBINER_RESIZED);
    // returned values for MPI_COMBINER_RESIZED
...
TEST(MpiDataTypeTest, test_type_groups) {
    ...
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<int>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<signed int>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<long>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<signed long>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<short>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<signed short>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<unsigned short>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<unsigned>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<unsigned int>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<unsigned long>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<long long int>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<long long>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<signed long long>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<unsigned long long>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<signed char>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<unsigned char>::category, xxxxx-1ing::TypeCategory::integer);

    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<int8_t>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<int16_t>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<int32_t>::category, xxxxx-1ing::TypeCategory::integer);

    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<uint8_t>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<uint16_t>::category, xxxxx-1ing::TypeCategory::integer);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<uint32_t>::category, xxxxx-1ing::TypeCategory::integer);

    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<float>::category, xxxxx-1ing::TypeCategory::floating);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<double>::category, xxxxx-1ing::TypeCategory::floating);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<long double>::category, xxxxx-1ing::TypeCategory::floating);

    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<bool>::category, xxxxx-1ing::TypeCategory::logical);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<xxxxx-1ing::kabool>::category, xxxxx-1ing::TypeCategory::logical);

    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<std::complex<float>>::category, xxxxx-1ing::TypeCategory::complex);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<std::complex<double>>::category, xxxxx-1ing::TypeCategory::complex);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<std::complex<long double>>::category, xxxxx-1ing::TypeCategory::complex);

    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<std::complex<int>>::category, xxxxx-1ing::TypeCategory::contiguous);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<char>::category, xxxxx-1ing::TypeCategory::character);
    EXPECT_EQ(xxxxx-1ing::mpi_type_traits<DummyType>::category, xxxxx-1ing::TypeCategory::contiguous);
}
